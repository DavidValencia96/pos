    ...
    <body>
        <header class="clearfix">
            ...
            <div id="company" class="clearfix">
                <div id="negocio">Farmacia (nombre)</div>
                <div>Direccion: Numero ###,<br /> Ciudad, Provincia</div>
                <div>(321) 584 5480</div>
                <div><a href="mailto:juan.valenciaor@amigo.edu.co">juan.valenciaor@amigo.edu.co</a></div>
            </div>
    ';
        ...
        <main>
            <table>
                ...
                $plantilla.='
                    ...
                    <tr>
                        <td colspan="8" class="grand total">iva(18%)</td>
        ...
        <footer>
            Created by Juan David Valencia 
        </footer>
    </body>';
    return $plantilla;
}
