                            ...
                            if(tipo_usuario==3){
                                if(usuario.tipo_usuario!=2){
                                    ...
                                    <button class="borrar-usuario btn btn-danger mr-1" type="button" data-toggle="modal" data-target="#confirmar">
                                        <i class="fas fa-window-close mr-1"></i>Eliminar usuario
                                    </button>
                                    `;
                                }
                                if(usuario.tipo_usuario==2){
                                    ...
                                    <button class="ascender btn btn-primary ml-1" type="button" data-toggle="modal" data-target="#confirmar">
                                        <i class="fas fa-sort-amount-up mr-1"></i>Ascedender
                                    </button>
                                    `;
                                }
                                if(usuario.tipo_usuario==1){
                                    ...
                                    <button class="descender btn btn-secondary type="button" data-toggle="modal" data-target="#confirmar">
                                        <i class="fas fa-sort-amount-down mr-1"></i>Descedender
                                    </button>
                                    `;
                                }
                            }
                            else{  
                                if(tipo_usuario==1 && usuario.tipo_usuario!=1 && usuario.tipo_usuario!=1){
                                    template+=`
