    ...
    async function producto_mas_vendido(){
        ...
        let datos={
            ...
            datasets:[
                ...
                {
                    label: lista[2].nombre+ lista[2].concentracion+lista[2].adicionale,
                ...
                {
                    label: lista[3].nombre+ lista[3].concentracion+lista[3].adicionale,
                    ...
                    data: [lista[3].cantidad]
                },
                {
                    label: lista[4].nombre+ lista[4].concentracion+lista[4].adicionale,
