...
<title>ADMIN || Gestión lote</title>
            ...
            <div class="modal-content">
                <div class="card card-success">
                    ...
                    <div class="card-body">
                        ...
                        <form id="form-editar-lote">
                            <div class="form-group">
                                ...
                                <label id="codigo_lote">codigo_lote</label>
                            </div>
                            <div class="form-group">
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn bg-gradient-primary float-right m-1">Crear producto</button>
...
<!-- Content Wrapper. Contains page content -->
    ...
    <section>
        <div class="container-fluid">
            <div class="card card-success">
                <div class="card-header">
                    <h3 class="card-title">Gestión lotes</h3>
