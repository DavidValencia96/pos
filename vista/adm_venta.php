...
<title>ADMIN || Gestión venta</title>
            ...
            <div class="modal-content">
                <div class="card card-success">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="codigo_fecha">Fecha:</label>
                            <span id="codigo_fecha"></span>
                        </div>
                        <div class="form-group">
                            <label for="codigo_cliente">Cliente:</label>
                            <span id="codigo_cliente"></span>
                        </div>
                        <div class="form-group">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-3 col-6">
                            ...
                            <a href="adm_consultas.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <!-- ./col -->
                        <div class="col-lg-3 col-6">
